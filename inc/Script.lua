...
if MsgText[1] == "ضع صورة الترحيب" or MsgText[1]=="ضع صورة الترحيب" then 
...
• من السبام والتوجية والتكرار .
 • معرف المطور » ]]..SUDO_USER:gsub([[\_]],'_')..[[ 
]])

return false
else
return "• لا توجد صورة مضافه للترحيب في البوت \n• لاضافه صورة الترحيب ارسل `وضع صورة الترحيب`"
end
end
...
if not msg.SudoUmath then return "*•* هذا الامر يخص { الهكر فواز , المطور الاساسي } فقط " end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'للاشتراك في السورس',url="t.me/rosnw1"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
return '• اصدار سورس روسنى  : *v'..version..'* '
end
