...
if MsgText[1] == 'اسماء فنانين' or MsgText[1] == 'فنان' then
  katu = {
  'اصاله','مشاعل','بلقيس','يارا','اصاله','مشاعل','بلقيس','عبادي الجوهر','مشاعل','يارا','ماجد المهندس','عبادي الجوهر','عبدالمجيد','عبادي الجوهر','عبادي الجوهر','ماجد المهندس','طلال مداح','ماجد المهندس','عبدالمجيد','عبدالمجيد','ماجد المهندس','عبدالمجيد','شيرين','عبدالمجيد','شيرين','عبدالمجيد','محمد عبده','اصاله','راشد الماجد','اليسا','شيرين','اليسا','راشد الماجد','اصاله','ادهم نابلسي','حسين الجسمي','شيرين','محمد رمضان','شيرين','نانسي عجرم','فضل شاكر','نانسي عجرم','فضل شاكر','نانسي عجرم','فضل شاكر','نانسي عجرم','نانسي عجرم','فضل شاكر','رابح صقر','ادهم نابلسي','رابح صقر','اصاله','ادهم نابلسي',
  };
name = katu[math.random(#katu)]
redis:set(boss..':Fan_nan:'..msg.chat_id_,name)
name = string.gsub(name,'اصاله','سؤال بسيط ؟')
name = string.gsub(name,'مشاعل','المصايب ؟')
name = string.gsub(name,'بلقيس','من يسرق القلب ؟')
name = string.gsub(name,'يارا','صدفه ؟')
name = string.gsub(name,'اصاله','عقوبه ؟')
name = string.gsub(name,'مشاعل','لانك غير ؟')
name = string.gsub(name,'بلقيس','حقير الشوق ؟')
name = string.gsub(name,'عبادي الجوهر','حسبتك لي ؟')
name = string.gsub(name,'مشاعل','صوب الرياض ؟')
name = string.gsub(name,'يارا','ارتكبت ؟')
name = string.gsub(name,'ماجد المهندس','ودعت روحي ؟')
name = string.gsub(name,'عبادي الجوهر','خلاص ارجع ؟')
name = string.gsub(name,'عبدالمجيد','من مثلك ؟')
name = string.gsub(name,'عبادي الجوهر','حبك سماء ؟')
name = string.gsub(name,'عبادي الجوهر','قالو ترى ؟')
name = string.gsub(name,'ماجد المهندس','وٱهيامه ؟')
name = string.gsub(name,'طلال مداح','من بعد مزح ؟')
name = string.gsub(name,'ماجد المهندس','تحبك روحي ؟')
name = string.gsub(name,'عبدالمجيد','خلص حنانك ؟')
name = string.gsub(name,'عبدالمجيد','غلطه ؟')
name = string.gsub(name,'ماجد المهندس','هتان ؟')
name = string.gsub(name,'عبدالمجيد','انتحل شخصيتك ؟')
name = string.gsub(name,'شيرين','مش قد الهوى ؟')
name = string.gsub(name,'عبدالمجيد','يابعدهم ؟')
name = string.gsub(name,'شيرين','حبه جنه ؟')
name = string.gsub(name,'عبدالمجيد','حن الغريب ؟')
name = string.gsub(name,'محمد عبده','نجمتين ؟')
name = string.gsub(name,'اصاله','شامخ ؟')
name = string.gsub(name,'راشد الماجد','يا أهل الهوى ؟')
name = string.gsub(name,'اليسا','مريضة اهتمام ؟')
name = string.gsub(name,'شيرين','نساي ؟')
name = string.gsub(name,'اليسا','ع بالي حبيبي ؟')
name = string.gsub(name,'راشد الماجد','ولهان ؟')
name = string.gsub(name,'اصاله','نكته بايخه ؟')
name = string.gsub(name,'ادهم نابلسي','حان الان ؟')
name = string.gsub(name,'حسين الجسمي','بالبنط العريض ؟')
name = string.gsub(name,'شيرين','مشاعر ؟')
name = string.gsub(name,'محمد رمضان','رايحين نسهر ؟')
name = string.gsub(name,'شيرين','سلم على الشهداء ؟')
name = string.gsub(name,'نانسي عجرم','يا بنات ؟')
name = string.gsub(name,'فضل شاكر','نسيت انساك ؟')
name = string.gsub(name,'نانسي عجرم','كتكوته ؟')
name = string.gsub(name,'فضل شاكر','إبقى قابلني ؟')
name = string.gsub(name,'نانسي عجرم','انت إيه ؟')
name = string.gsub(name,'فضل شاكر','يا حياة الروح ؟')
name = string.gsub(name,'نانسي عجرم','حلم البنات ؟')
name = string.gsub(name,'نانسي عجرم','سنة حلوة يا جميل ؟')
name = string.gsub(name,'فضل شاكر','فين لياليك ؟')
name = string.gsub(name,'رابح صقر','مقصر في سؤالك ؟')
name = string.gsub(name,'ادهم نابلسي','تقبلني ؟ ')
name = string.gsub(name,'رابح صقر','ابرك الساعات ؟')
name = string.gsub(name,'ادهم نابلسي','بتعرف شعور ؟')
name = string.gsub(name,'رابح صقر','أحسن الظن ؟')
name = string.gsub(name,'اصاله','اشتقت لك ؟')
name = string.gsub(name,'ادهم نابلسي','هو الحب ؟')
